...
const textFields = new Set(['title', 'defaultTitle', 'brand', 'description', 'heading', 'eyebrow', 'lede', 'intro', 'label', 'tag', 'summary', 'imageAlt', 'coverAlt', 'originalTitle', 'future', 'linkLabel', 'creditsLabel', 'licenseLabel', 'year', 'kind', 'body', 'imageCredit', 'text', 'meta', 'quote', 'attribution', 'value', 'author', 'blurb', 'sourceLabel', 'reflection', 'translation', 'work', 'name', 'track', 'note', 'alternateLabel', 'category', 'footerText']);
const containers = new Set(['sections', 'links', 'categories', 'items', 'following', 'credits', 'books', 'readingPaths', 'excerpts', 'artists', 'facts', 'paragraphs', 'themes', 'navigation']);
