...
const runtime = ['astro-preview', 'cli', 'content-search', 'document-lifecycle', 'inline-session', 'project-config', 'project-tools', 'server-core', 'server'];
const web = ['app.js', 'command-palette.js', 'command-palette.css', 'draft-reconcile.js', 'index.html', 'lifecycle.js', 'lifecycle.css', 'studio.css', 'workspace-storage.js', 'writer.js', 'writer.css'];
...
function manifest(source) {
  ...
  return {
    name: '@willqing/will-studio', version: '0.2.0', private: true, type: 'module', license: 'UNLICENSED',
